...
def test_create_help_request():
    ...
    assert create_Help_request.received_help_requests[0]['HelpWithSomethingElse'] == True
    ...
    assert create_Help_request.received_help_requests[0]['CallbackRequired'] == True
