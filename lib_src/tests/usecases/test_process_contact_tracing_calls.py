...
def test_processing_new_power_bi_spreadsheet():
    ...
    return_inbound_files = [
        ...
        {'name': "file2", 'id': 'inbound_folder_id'}
    ]
    ...
    assert fake_google_drive_gateway.created_spreadsheets == [
        {'folder_id': 'outbound_folder_id', 'spreadsheet_name': 'Hackney_CT_FOR_UPLOAD_file2_' + today},
        {'folder_id': 'outbound_folder_id', 'spreadsheet_name': 'city_CT_FOR_UPLOAD_file2_' + today}
    ]
